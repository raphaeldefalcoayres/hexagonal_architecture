import PostgreSQLAdapter from "../src/adapters/outbound/PostgreSQLAdapter";
import ParkedCarDatabaseRepository from "../src/application/ports/outbound/ParkedCarDatabaseRepository";
import Checkin from "../src/application/usecases/Checkin";
import Checkout from "../src/application/usecases/Checkout";
import GetParkedCars from "../src/application/usecases/GetParkedCars";
